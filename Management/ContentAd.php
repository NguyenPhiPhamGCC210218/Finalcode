                ...
                if ($result->num_rows > 0) {
                    while ($product = $result->fetch_assoc()) { ?>
                        <div class="product">
                            ...
                            <h4><?php echo $product['Pro_Name']; ?></h4>
                            <p style="color:#e65c76">Quantity Sold: <?php echo $product['total_quantity']; ?></p>
...
.container hr {
    ...
    border: 2px solid #000; /* Black line */
}
...
.star {
    ...
    margin: 10px 0; /* Space around stars */
}
...
@media (max-width: 768px) {
    .product {
        flex: 0 0 45%; /* Two products per row */
    }
}

@media (max-width: 576px) {
    .product {
        flex: 0 0 100%; /* One product per row */
    }
}
...
@media (max-width: 768px) {
    ...
    .slide img {
        height: 300px; /* Reduce height for tablet screens */
    }

    .slider-nav button {
        padding: 6px 12px;
        font-size: 0.9rem; /* Make buttons slightly smaller */
    }
}
...
.search-input {
    outline: none;
    border: 3px solid #000; /* Adjust border style */
    border-radius: 16px;
    width: 676px;
    max-width: 100%; /* Ensure input doesn't exceed screen width */
    height: 56px;
    text-align: center;
    padding: 10px;
...
@media (max-width: 480px) {
    .search-input {
        width: 90%; /* Reduce input width for mobile */
    }

    .nutsearch {
        width: 70px;
        height: 45px; /* Further adjustment for mobile */
    }
}
...
.product {
    ...
    text-align: center;
    padding: 20px;
    width: 400px; /* Set width to 330px */
    height: 375px; /* Set height to 375px */
    transition: transform 0.3s, box-shadow 0.3s;
    display: flex;
    flex-direction: column;
    justify-content: space-between; /* Ensure content is aligned nicely */
}
...
.s-three-upper-img-container img {
    width: 400px;
    border: 2px solid #000; /* Adds a frame around the image */
    border-radius: 10px;
}
...
.section-three {
    ...
    text-align: center; /* Center text in all devices */
}
...
.s-three-upper-img-container img {
    ...
    border-radius: 10px;
    object-fit: cover;
    border: 2px solid #ddd; /* Subtle frame around image */
