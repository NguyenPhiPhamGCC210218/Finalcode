...
<script language="javascript">
        ...
        <form name="frm" method="post" action="">
            <a class="backhome" href="index1.php">←Back to index</a>
        <h1 class="h1manaCat">Management Product Supplier</h1>
        <p>
        <a href="?page=add_supplier" class="ManaAddCat"> <img src="./product-imgs/addicon.png" alt=""> Add Supplier</a>
        </p>
        <table id="tablecategory" class="table table-striped table-bordered"  cellspacing="0" width="100%" style="text-align: center; color:#000;">
			...
			<tr>
              ...
              <td style="text-align:center"><a href="?page=supplier_management&&function=del&&id=<?php echo $row["Sup_ID"]; ?>"
